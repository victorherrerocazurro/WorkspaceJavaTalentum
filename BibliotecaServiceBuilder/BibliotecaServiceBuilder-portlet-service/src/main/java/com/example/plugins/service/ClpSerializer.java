...
import com.example.plugins.model.LibroClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "BibliotecaServiceBuilder-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "BibliotecaServiceBuilder-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("com.example.plugins.model.impl.LibroImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.example.plugins.NoSuchLibroException")) {
            return new com.example.plugins.NoSuchLibroException();
        }
