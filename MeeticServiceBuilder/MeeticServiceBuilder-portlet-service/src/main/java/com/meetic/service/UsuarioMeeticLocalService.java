...
/**
 * Provides the local service interface for UsuarioMeetic. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UsuarioMeeticLocalServiceUtil
...
public interface UsuarioMeeticLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link UsuarioMeeticLocalServiceUtil} to access the usuario meetic local service. Add custom service methods to {@link com.meetic.service.impl.UsuarioMeeticLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
